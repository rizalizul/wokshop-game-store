<?php
  ...
  $query = "SELECT * FROM admin WHERE id_level='2';";
      ...
      <div class="container-fluid">
        ...
        <div class="row p-4">
          <div class="col-md-12 kotak">
              <h2 class="border-head">Data Bank
                  <a href="bank_add.php" class="btn btn-outline-dark float-end" role="button">Tambah Bank</a>
              </h2>
                          ...
                          ?>
                              <tr>
                                  ...
                                  <td class="text-center">
                                    <a href="bank_edit.php?id_admin=<?php echo $result['id_admin']; ?>" class="btn btn-warning text-white">Ubah</a> |
